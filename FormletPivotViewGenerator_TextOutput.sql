...
set @newline = '
'
select @q1 = 'if object_id(''LEGACYSPED.'+@ViewName+'DATATYPEPivot'', ''V'') is not null
DROP VIEW LEGACYSPED.'+@ViewName+'DATATYPEPivot
GO

create view LEGACYSPED.'+@ViewName+'DATATYPEPivot
as
