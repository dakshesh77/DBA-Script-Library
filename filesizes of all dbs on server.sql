...
(
	...
	AVERAGE_BYTES_PER_ROW		int		null,
	AVERAGE_DATA_BYTES_PER_ROW	int		null,
	AVERAGE_INDEX_BYTES_PER_ROW	int		null,
	AVERAGE_UNUSED_BYTES_PER_ROW	int		null,
...
order by
	-- Average_bytes_per_row desc
	USED_GB Desc, USED_MB desc
